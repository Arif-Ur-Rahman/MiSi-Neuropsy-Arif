...
from .views import HeroSlider,SpecialEvent,Service,Award,ClientCouncil,WhyChooseUsView,WhyChooseUsDetailsView,ContactForm,JobsPost,AppliedCandidates
urlpatterns =[
